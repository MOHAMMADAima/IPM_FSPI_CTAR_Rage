...
def create_histogram(monthly_data, town_name):
    ...
    ax.set_title('Distribution mensuelle de vaccins dans le CTAR', fontsize=44, weight='bold')  # Increased from 16 to 24
    ax.set_xlabel('Months', fontsize=40)  # Increased from 16 to 20
    ax.set_ylabel('Data Value', fontsize=40)  # Increased from 16 to 20

    # Increase the legend font size
    ax.legend(loc='upper right', fontsize=48)  # Increased from 14 to 18
